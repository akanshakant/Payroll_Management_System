    ...
    public partial class salary : Form
    {
        ...
        private void btnupdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlCmd.CommandText = "update from employeedb set ID = '" + ID + "',Firstname = '" + Firstname + "',Surname = '" + Surname + "'," +
                    "Address = '" + Address + "',Gender = '" + Gender + "',Mobile = '" + Mobile + "',Cityweighting = '" + Cityweighting + "',Salary = '" + Salary +
                    ...
                    "',Grosspay = '" + Grosspay + "',Deduction = '" + Deduction + "' WHERE ID = " + ID + "";
        ...
        private void btntotal_Click(object sender, EventArgs e)
        {
            ...
            txtpensionablepay.Text = String.Format("{0:c2}", Period * Pension);
             // ==============================================================================================================================
                     ...
                     sqlConn.Open();
                     sqlCmd.Connection = sqlConn;
                sqlCmd.CommandText = "insert into employeedb(ID,Firstname,Surname,Address,Gender," +
               "Mobile,Weight,Salary,Overtime,Otherpay,Tax,Pension,Studentloan,NIPay" +
               "Paydate,Taxperiod,Taxcode,NINumber,NICode,Taxable,Pensionable,Netpay,Grosspay,Deduction)" +
               ...
               txtNIPayment.Text + "','" + dateTimePicker1.Text + "','" + txttaxperiod.Text + "','" + txttaxcode.Text + "','" + txtNIPeriod.Text + "','" +
        ...
        private void btnpayslip_Click(object sender, EventArgs e)
        {
            ...
            rtPayslip.AppendText("\t\t" + "Weight" + "\t\t" + txtcityweighting.Text + "\n");
